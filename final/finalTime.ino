...
// /*
//     Função: gEd
//     Descrição: Vira o carro para a direita em torno do próprio eixo
// */
...
// /*
//     Função: gEe
//     Descrição: Vira o carro para a esquerda em torno do próprio eixo
// */
...
void loop(){
    ...
    stopCar(); /*Tem que passar o tempo de quanto tempo o carro vai ficar parado, recomendo utilizar entre 
    140 a 500 de microsegundos quando for uma movimentação contínua, caso o carro faça muitas movimentações ou haja a hipotese de pegar velocidade em uma descida como em rampa
    utilizar pelo menos 1000 de delay*/
    //Pode mudar a velocidade do motor utilizando as variaveis minSpeed e maxSpeed, caso for mudar os valores durante o código utilizar um delay de 20 microsegundos após a alteração.
    //Caso for fazer a movimentação do robô com peso baixo utilize o menor possível para ele se locomover da maneira mais devegar, SEM QUE O MOTOR APITE MUITO
    //Em funções que o robô anda para a Diagonal ou em casos de Direta e Esquerda utilizar 1/3 a mais da velocidade que está sendo usada ou 1/4 ou 2/4 a mais
    /*(Verificar qual fração fica melhor na movimentação) e demarcar*/
    // chamar a função e passar o tempo como parametro
    //andar(200); stopCar(200); virar(200); (Exemplo meramente ilustrativo)



//Lógica a baixo quase pronta da missão mid - Pode começar uma nova a partir ou recriar uma do 0
/*
  while (counter == 0){
